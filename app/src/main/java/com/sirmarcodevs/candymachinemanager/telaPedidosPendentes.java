...
public class telaPedidosPendentes extends AppCompatActivity {
    ...
    private void buscarPedidos() {
        ...
        Query query = FirebaseDatabase.getInstance().getReference().child("pedidos-pendentes");
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    pedidosAdapter = new PedidosAdapter(context, listPedidos,"Pendentes");
